...
void Renderer::recreateSwapChain() {
    ...
    if (engineSwapChain == nullptr) {
        engineSwapChain = std::make_unique<SwapChain>(engineDevice, extent);
    } else {
        std::shared_ptr<SwapChain> oldSwapChain = std::move(engineSwapChain);
        engineSwapChain = std::make_unique<SwapChain>(engineDevice, extent, oldSwapChain);
